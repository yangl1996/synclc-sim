...
#attacker
./synclc-sim -lottery 0.01 -parallel 4 -port 10000 -start $startTime -attack -seed 1 &> attacker1.txt &
./synclc-sim -lottery 0.01 -parallel 4 -port 10001 -start $startTime -attack -seed 1 &> attacker2.txt &
...
mm-delay 50 mm-link fast.mahi fast.mahi --uplink-queue=pie --uplink-queue-args="qdelay_ref=20, packets=200, max_burst=150" --downlink-queue=pie --downlink-queue-args="qdelay_ref=20, packets=200, max_burst=150" -- ./synclc-sim -local 1 -global 1 -lottery 0.1 -parallel 4 -peers 172.16.232.130:9002,172.16.232.130:10001 -port 9001 -start $startTime &> victim2.txt &
